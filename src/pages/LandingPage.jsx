...
const LandingPage = () => {
  return (
    <div className="bg-white min-h-screen flex flex-col">
      {/* Navbar */}
      <header className="bg-primary text-white py-4 px-8 flex justify-between items-center shadow-md">
      ...
      >
        ...
        <div className="relative z-10 text-white max-w-2xl px-4">
          ...
          <Link
            to="/login"
            className="bg-white text-primary px-8 py-3 rounded-md text-lg font-medium hover:bg-gray-100 transition"
          >
            Get Started
          </Link>
        </div>
