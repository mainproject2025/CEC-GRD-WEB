...
const Dashboard = () => {
  ...
  return (
    <div className="min-h-screen bg-gray-50 flex">
      {/* Sidebar */}
      <aside className="w-64 bg-primary text-white flex flex-col p-6 shadow-lg">
                ...
                <ul className="space-y-3">
                  {[
                    ...
                    <li key={index}>
                      <a
                        href={item.link}
                        className="block px-4 py-2 bg-violet-100 rounded-lg hover:bg-violet-200 transition font-medium text-primary shadow-sm"
                      >
                        {item.name}
                      </a>
                    </li>
            ...
            {activeTab === "create" && (
              <>
                ...
                <form className="space-y-4 mb-10">
                  <div>
                    <label className="block text-sm text-primary mb-1 font-medium">
                      Name
                    </label>
                    <input
                      type="text"
                      placeholder="Enter arrangement name"
                      className="w-full px-4 py-2 border rounded-md focus:outline-none focus:ring-2 focus:ring-[#423FE5]"
                    />
                  </div>
                  <div>
                    <label className="block text-sm text-primary mb-1 font-medium">
